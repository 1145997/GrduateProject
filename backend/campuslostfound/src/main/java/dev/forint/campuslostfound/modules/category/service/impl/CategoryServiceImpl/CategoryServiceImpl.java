...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
    ...
    private final dev.forint.campuslostfound.modules.lostfound.mapper.LostFoundMapper lostFoundMapper;
    @Override
    ...
    public void deleteCategory(Long id) {
        ...
        Long usedCount = lostFoundMapper.selectCount(
                new LambdaQueryWrapper<dev.forint.campuslostfound.modules.lostfound.entity.LostFound>()
                        .eq(dev.forint.campuslostfound.modules.lostfound.entity.LostFound::getCategoryId, id)
        );
